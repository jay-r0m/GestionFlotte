...
namespace GestionFlotte.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(FlotteContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("RoleID,Nom")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoleID,Nom")] Role role)
        {
            if (id != role.RoleID)
            {
                return NotFound();
